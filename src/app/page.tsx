      ...
      <ScrollReveal variant="fade-up">
        <section id="featured-products-section" className="py-16 md:py-24 px-4 sm:px-6 md:px-8 border-t border-divider/60 max-w-[1400px] mx-auto relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredCMS.map((p, idx) => (
              <ScrollReveal key={p.id} variant="stagger-item" delay={idx * 0.1}>
                <GlassCard 
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-5 relative z-10">
              {(howWeWork.steps || []).map((item, idx) => (
                <ScrollReveal key={item.id || idx} variant="stagger-item" delay={idx * 0.1}>
                  <GlassCard className="p-6 border border-glass-border relative hover:border-accent-blue/40 transition-all select-none text-left shadow-lg group">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {(capabilities.items || []).map((cap, i) => (
                  <ScrollReveal key={cap.id || i} variant="stagger-item" delay={i * 0.08}>
                    <div className="p-5 rounded-2xl bg-bg-secondary/40 border border-glass-border hover:border-accent-blue/30 transition-all flex gap-4 select-none backdrop-blur-xl group">
